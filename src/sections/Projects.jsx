...
//                 <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:shadow-blue-500/20 transition">
//                   <img src={proj.img} className="h-60 w-full object-cover" />
//                   <div className="p-6">
//                     <h3 className="text-xl font-semibold">{proj.title}</h3>
//                     <p className="text-gray-400 mt-4">{proj.desc}</p>
//                   </div>
//                 </div>
//               </Tilt>
//             </motion.div>
